...
export const NoiseMeterView = ({ currentClass }) => {
  ...
  const handleToggleMic = async () => {
    if (isMicOn) {
      ...
      // Start Microphone using Web Audio API AnalyserNode
      try {
    ...
    <div className="space-y-6 pb-12 animate-in fade-in select-none">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-purple-100 shadow-soft space-y-6">
        ...
        <div className="space-y-3">
          ...
          {/* Noise Zones Reference Legend (Screenshot 5) */}
          <div className="grid grid-cols-3 gap-3 pt-2 text-center text-xs font-bold">
            <div className="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900">
              <span className="block font-black text-emerald-800">Yên tĩnh</span>
              <span className="text-[10px] text-emerald-600">0 - 40%</span>
            </div>

            <div className="p-2.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-900">
              <span className="block font-black text-amber-800">Hơi ồn</span>
              <span className="text-[10px] text-amber-600">40 - 70%</span>
            </div>

            <div className="p-2.5 rounded-xl bg-coral-50 border border-coral-200 text-coral-900">
              <span className="block font-black text-coral-800">Rất ồn</span>
              <span className="text-[10px] text-coral-600">70 - 100%</span>
            </div>
          </div>
