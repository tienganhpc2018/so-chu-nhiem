  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'filmreel', label: 'Cuộn Phim Kỷ Niệm', icon: Film, badge: 'AI ✨', badgeColor: 'bg-purple-100 text-purple-700 font-bold' },
        { id: 'filmstrip', label: 'Quay Cuộn Phim', icon: Film, badge: 'MINI', badgeColor: 'bg-mint-100 text-mint-700 font-bold' },
